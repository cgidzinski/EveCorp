...
passport.deserializeUser(function(id, done) {
  User.findById(id, function(err, user) {
   ...
   passport.use('eveonline', new EveOnlineStrategy({
    clientID: "507736f9caf04913ba84ac432a350a82",
    clientSecret: "eB7u3befgw1nrQGe7GACNvcT9D7aKCDtgExCFZCy",
      callbackURL: "http://lan-ce.com:8081/auth/eveonline/callback",
      userAgent: 'http://lan-ce.com:8081/'
    },
